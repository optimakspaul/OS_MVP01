...
|---|---|---|---|---|---|---|---|---|
| ISSUE-000 | Phase 0 | Repository and Constitution Context Verification | None | None | Confirms governance readiness | Pending |  |  |
...
Next issue allowed to start? Yes / Yes with warnings / No
