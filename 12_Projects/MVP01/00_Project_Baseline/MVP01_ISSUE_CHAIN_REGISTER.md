...
| ISSUE-012 | Phase 4 | Lead / Customer Flow | ISSUE-011 | ISSUE-011_DONE_Report; client workspace notes | Lead list; lead detail; customer profile; status notes | Pending |  | Locked until ISSUE-012 workpack approval and execution on its own branch. |
...
Next issue allowed to start? Yes with warnings. ISSUE-012 requires ISSUE-012 workpack approval and execution on its own branch.
